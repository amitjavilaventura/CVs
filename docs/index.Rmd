...
Study of Xrn1 and Ccr4 roles in yeast nucleosome architecture and gene transcription. | Analysis of MNase-seq data from Xrn1-, Ccr4-mutant and WT yeast strains. | MNase-qPCR experiments, including MNase DNA digestion, primer desing, qPCRs and analysis. 

- Thesis title: *Influence of Xrn1 in nucleosome positioning across <ins>Saccharomyces cerevisiae</ins> genome and its effects in transcription*.
...
Microbiological and molecular analyses of food and water for pathogen detection and food forensics |  Study of butyrate effects on the ileal microbiota of colectomized colorectal cancer patients. | DNA extraction of intestinal mucosa biopsies | qPCR experiments to detect clusters and families of bacteria | NGS data analysis to quantify bacterial genders in intestinal biopsies. 
