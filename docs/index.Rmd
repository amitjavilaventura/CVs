...
### `r fa(name = "user")` &nbsp; Bioinformatician at the [*Istituto Europeo di Oncologia*](https://www.research.ieo.it/adri%C3%A0-mitjavila-ventura/)

```{r image_me, eval = T}
htmltools::img(src = "fotojo.png", 
               alt = 'foto_carnet', 
...
<p> `r fa(name = "home")` &nbsp; <b>Girona (Spain) - Milan (Italy)</b> </p>

<p> `r fa(name = "building")` &nbsp; <b>Istituto Europeo di Oncologia</b> </p>

<p> `r fa(name = "at")` &nbsp; <b>adria.mitjavila94 @ gmail.com</b> </p>


<a href="https://amitjavilaventura.github.io/">`r fa(name = "globe")`</a> &nbsp;
<a href="https://github.com/amitjavilaventura">`r fa(name = "github")`</a> &nbsp;
<a href="https://gitlab.com/amitjavilaventura">`r fa(name = "gitlab")`</a> &nbsp; 
<a href="https://www.linkedin.com/in/adria-mitjavila-ventura/">`r fa(name = "linkedin")`</a> &nbsp; 
<a href="https://orcid.org/0000-0002-0337-1929"> **ORCID** </a> &nbsp;

***

Former biotechnologist who is living between computers. My interests are mostly related to omics data analysis related to Epigenetics research. 
...
My full list of publications can be consulted [here](https://amitjavilaventura.github.io/publications/).
...
# Other honours and awards {.tabset}
